      ...
      <div className="space-y-6 p-4">
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <Button variant="outline" onClick={() => router.push("/employee/pengumuman")}>
    ...
    <div className="space-y-6 p-4">
      <PageHeader
        actions={[
          {
            label: "Edit",
            onClick: () => router.push(`/employee/pengumuman/${id}/edit`),
            icon: Edit,
            variant: "outline",
          },
        ]}
      ...
      <div>
        <Button
          variant="outline"
          onClick={() => router.push("/employee/pengumuman")}
        >
          <ArrowLeft className="h-4 w-4 mr-2" />
          Kembali ke Daftar
        </Button>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-4">
                  <Button
                    variant="outline"
                    onClick={() => router.push(`/employee/pengumuman/${id}/attachments`)}
                  >
