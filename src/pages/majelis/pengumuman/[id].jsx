      ...
      <div className="space-y-6 p-4">
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <Button variant="outline" onClick={() => router.push("/majelis/pengumuman")}>
    ...
    <div className="space-y-6 p-4 bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors">
      <PageHeader
        actions={[
          {
            label: "Edit",
            onClick: () => router.push(`/majelis/pengumuman/${id}/edit`),
            icon: Edit,
            variant: "outline",
          },
          {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <CardTitle className="text-2xl text-gray-900 dark:text-white">{pengumuman.judul}</CardTitle>
                    {pengumuman.isPinned && (
          ...
          {pengumuman.kontenDinamis && (
            <Card>
              <CardHeader>
                <CardTitle className="text-gray-900 dark:text-white">Informasi Tambahan</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="prose dark:prose-invert max-w-none">
                  <div
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-4">
                  <Button
                    variant="outline"
                    onClick={() => router.push(`/majelis/pengumuman/${id}/attachments`)}
                  >
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-gray-900 dark:text-white">Informasi Pengumuman</CardTitle>
            </CardHeader>
