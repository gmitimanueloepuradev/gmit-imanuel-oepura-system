...
export default function EditPengumumanPage() {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      router.push(`/majelis/pengumuman/${id}`);
    },
    onError: (error) => {
      showToast({
        title: "Gagal",
    ...
    <div className="space-y-6 p-4">
      <PageHeader
        breadcrumb={[
          ...
          { label: pengumuman.judul || "Edit", href: `/majelis/pengumuman/${id}` },
          { label: "Edit" },
        ]}
      ...
      <div>
        <Button
          variant="outline"
          onClick={() => router.push(`/majelis/pengumuman/${id}`)}
        >
                  ...
                  <div className="border-t pt-6">
                    ...
                    <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                      ...
                      <Button
                        ...
                        variant="outline"
                        onClick={() =>
                          router.push(`/majelis/pengumuman/${id}/attachments`)
                        }
                      >
                        Kelola Lampiran
                      </Button>
