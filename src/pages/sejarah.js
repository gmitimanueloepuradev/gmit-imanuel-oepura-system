        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-700 max-w-3xl mx-auto">
              Nilai-nilai dan tradisi yang terus kami lestarikan untuk generasi
              mendatang
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-amber-100">
              ...
              <p className="text-amber-700 text-center leading-relaxed">
                Liturgi dan tatacara ibadah yang memadukan unsur Reformed dengan
                kearifan lokal Timor, menciptakan pengalaman spiritual yang
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-amber-100">
              ...
              <p className="text-green-700 text-center leading-relaxed">
                Pelestarian bahasa, adat istiadat, dan nilai-nilai budaya Timor
                yang diintegrasikan dengan ajaran Kristen dalam kehidupan
                sehari-hari jemaat.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border border-amber-100">
              ...
              <p className="text-blue-700 text-center leading-relaxed">
                ...
                sosial, pendidikan, dan pemberdayaan ekonomi yang berkelanjutan.
              </p>
            </div>
          </div>
        </div>
