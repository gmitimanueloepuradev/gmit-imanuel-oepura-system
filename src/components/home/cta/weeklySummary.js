  ...
  return (
    <div className="flex flex-col md:flex-row md:bg-gray-300 md:dark:bg-gray-700 md:rounded-3xl p-6 md:p-8 shadow-lg w-full md:w-4/5 mx-auto gap-6 md:gap-12 transition-colors duration-300">
      ...
      <div className="flex flex-1 flex-col justify-center text-gray-800 dark:text-white transition-colors duration-300">
        <h2 className="divider divider-start divider-neutral dark:divider-gray text-4xl font-bold mb-4 tracking-wide font-sans">Weekly Summary</h2>
        <h3 className="text-xl font-medium mb-4 text-gray-700 dark:text-gray-200">Theme Goes Here</h3>
        ...
        <p className="mb-8 italic font-semibold text-gray-700 dark:text-gray-200">— Mattew 3 : 2</p>
