...
export default function ChurchOverview() {
  ...
  return (
    <div id="church-overview" className="py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-8'}`}>
            ...
            <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Gereja yang berdiri kokoh sejak 1950-an, melayani dengan kasih dan melestarikan budaya Timor
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100 shadow-lg">
                ...
                <p className="text-gray-700 leading-relaxed text-lg">
                  GMIT Imanuel Oepura adalah gereja yang berkomitmen untuk hidup bersama dalam kasih Kristus,
                  melayani sesama, dan melestarikan budaya lokal Timor. Kami percaya bahwa iman Kristen dapat
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border border-green-100 shadow-lg">
                ...
                <p className="text-gray-700 leading-relaxed text-lg">
                  Lebih dari 70 tahun melayani, kami terus mengembangkan berbagai program pelayanan untuk
                  segala usia - dari sekolah minggu hingga persekutuan lansia, dari pelayanan pastoral
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border border-purple-100 shadow-lg">
                ...
                <p className="text-gray-700 leading-relaxed text-lg">
                  Kami bangga melestarikan budaya Timor dalam ibadah dan kehidupan gereja. Bahasa lokal,
                  musik tradisional, dan nilai-nilai kearifan lokal menjadi bagian integral dari
              ...
              <div className="relative overflow-hidden rounded-2xl shadow-2xl group">
                ...
                <div className="absolute top-4 left-4">
                  <div className="bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
                    <span className="text-sm font-semibold text-blue-800">Sejak 1950</span>
                  </div>
                </div>

                <div className="absolute bottom-4 left-4 right-4">
                  <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                    <h4 className="font-bold text-gray-800 mb-1">GMIT Imanuel Oepura</h4>
        ...
        <div className={`transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-8'}`}>
          <div className="bg-gradient-to-r from-slate-800 to-blue-900 rounded-3xl p-8 lg:p-12 text-white shadow-2xl">
            <div className="text-center mb-8">
              <h3 className="text-2xl lg:text-3xl font-bold mb-4">Nilai-Nilai Yang Kami Junjung</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center group">
                ...
                <h4 className="text-xl font-bold mb-2 text-yellow-300">Kasih</h4>
                <p className="text-gray-300 leading-relaxed">
                  Hidup dalam kasih Kristus dan mengasihi sesama tanpa memandang perbedaan
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Bertumbuh dalam iman yang kokoh dengan berpedoman pada Firman Allah
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <h4 className="text-xl font-bold mb-2 text-blue-300">Pelayanan</h4>
                <p className="text-gray-300 leading-relaxed">
                  Melayani dengan sukacita untuk kemuliaan Tuhan dan kebaikan masyarakat
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Call to Action */}
        <div className={`text-center mt-12 transition-all duration-1000 delay-900 ${isVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-8'}`}>
