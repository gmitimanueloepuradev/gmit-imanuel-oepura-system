        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 group">
            <div className="flex-1 md:text-right">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 transform group-hover:scale-105 transition-all duration-300">
                <h3 className="text-2xl font-bold text-blue-300 mb-4">Awal Mula (1950-an)</h3>
                <p className="text-lg leading-relaxed text-gray-200">
                  GMIT Imanuel Oepura didirikan sebagai bagian dari pelayanan gereja di wilayah Timor.
                  Gereja ini lahir dari semangat penyebaran Injil dan kebutuhan masyarakat lokal untuk
                  memiliki tempat ibadah yang dapat melayani komunitas dengan budaya dan bahasa setempat.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 group">
            ...
            <div className="flex-1">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 transform group-hover:scale-105 transition-all duration-300">
                <h3 className="text-2xl font-bold text-green-300 mb-4">Periode Pertumbuhan (1970-1990)</h3>
                <p className="text-lg leading-relaxed text-gray-200">
                  Masa ini ditandai dengan pembangunan gedung gereja yang lebih besar dan pengembangan
                  berbagai pelayanan. Jemaat mulai bertumbuh pesat dengan berbagai program pelayanan
                  seperti sekolah minggu, persekutuan pemuda, dan pelayanan sosial kepada masyarakat.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 group">
            <div className="flex-1 md:text-right">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 transform group-hover:scale-105 transition-all duration-300">
                <h3 className="text-2xl font-bold text-purple-300 mb-4">Era Modern (1990-Sekarang)</h3>
                <p className="text-lg leading-relaxed text-gray-200">
                  Memasuki era modern, GMIT Imanuel Oepura terus berkembang dengan adopsi teknologi
                  dalam pelayanan, program-program inovatif untuk berbagai kalangan usia, dan
                  keterlibatan aktif dalam pembangunan masyarakat lokal serta pelestarian budaya Timor.
                </p>
              </div>
            </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
              <h3 className="text-3xl font-bold text-yellow-300 mb-6">Visi Kedepan</h3>
              <p className="text-xl leading-relaxed text-gray-200 max-w-4xl mx-auto">
                Hari ini, GMIT Imanuel Oepura terus berkomitmen untuk menjadi gereja yang hidup,
                relevan, dan melayani dengan kasih. Kami mengintegrasikan nilai-nilai Kristen dengan
                kearifan lokal, menciptakan ruang dimana setiap orang dapat bertumbuh dalam iman
